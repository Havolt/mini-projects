...
function setUpLayout() {
    ...
    document.querySelector('.main__body__story-sec__misc__author').innerHTML = layoutData.author;
    document.querySelector('.main__body__story-sec__misc__date').innerHTML = newStoryDate.toUTCString();
